...
/*
  ...
  returns 5: 58551.8
*/
Calculator.prototype.round = function (value, precision, mode) {
...
// BruttoNetto class
function BruttoNetto (gross, options) {
  this.name = "BruttoNetto Calculator";
  this._options = options || {};
  // kwota gross
  this._gross = gross;
};

BruttoNetto.prototype = new Calculator();
...
/**
  ...
  sickness 2,45%
*/
BruttoNetto.prototype.countInsurance = function() {
  var results;
...
// var bn = new BruttoNetto(1500);
// console.log(bn, bn.round(1.1749999999999, 2));
